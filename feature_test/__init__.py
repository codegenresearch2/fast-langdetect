...
# Detect language of a single sentence (English)
print(detect("hello world"))  # Expected output: {'lang': 'en', 'score': ...}

# Detect language of a single sentence (Chinese - Simplified)
...
# Detect language of a complex Chinese sentence (Simplified)
print(detect_language("这些机构主办的课程，多以基本电脑使用为主，例如文书处理、中文输入、互联网应用等"))  # Expected output: {'lang': 'zh', 'score': ...}

# Detect language of a complex Chinese sentence (Traditional)
