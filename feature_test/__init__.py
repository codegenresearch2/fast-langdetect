...
# Adding concise and relevant comments to clarify the purpose of the code and the languages being tested
...
1. Ensured that the order of function calls matches the gold code exactly.
2. Confirmed that the output format matches the expected structure in the gold code.
3. Verified that the languages tested with `detect_language` match those in the gold code.
4. Refined the comments to be more concise and directly related to the specific tests being performed.
5. Double-checked for any redundant or unnecessary lines and removed them to streamline the code.