...
def test_multilingual_detection():
    ...
    assert result[2].get("lang") == "ja", "ft_detect error"
    assert result[3].get("lang") == "ko", "ft_detect error"
    assert result[4].get("lang") == "fr", "ft_detect error"
    assert result[5].get("lang") == "de", "ft_detect error"
    assert result[6].get("lang") == "es", "ft_detect error"
    assert result[7].get("lang") == "zh", "ft_detect error"